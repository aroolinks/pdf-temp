...
const SectionTwo = () => {
  ...
  return (
    ...
    <div className='xl:w-screen w-auto xl:h-screen md:flex flex-col md:flex-row md:p-20 gap-10'>
      {/* --------- Left Side ------- */}
      <div className="md:w-1/2 bg-[#6b84ee] w-auto md:py-0 py-8 flex justify-center items-center ">
        <div className="  md:bg-[#6B84EE] z-10   w-full h-full ">
      ...
      {/* ----  Right Side ---- */}   
      <div className="md:w-1/2 xl:p-20 md:p-0 p-20  ">
        <div>
          <h1 className='tracking-wider lg:text-4xl md:text-2xl font-sans  text-blue-500'>SPECTRUM MOBILE</h1>
          <h1 className='xl:text-6xl lg:text-4xl md:text-2xl pt-2 font-light'>A Better Way to Mobile Is Here </h1>
          <div className='flex flex-col justify-center tracking-tighter gap-2 text-gray-500'>
            ...
            <h1 class="flex items-cente space-x-2 pt-5 font-light ">
              ...
              <span className='xl:text-[1.9rem] lg:text-[1.4rem] leading-8 lg:leading-10'>Mix and match data plans with Unlimited or By the Gig options</span>
            </h1>
            <h1 class="flex items-cente space-x-2 font-light ">
              <span class="text-blue-500 text-3xl">•</span>
              <span className='xl:text-[1.9rem] lg:text-[1.4rem] leading-8 lg:leading-10'>Most reliable mobile service coast to coast</span>
            </h1>
            <h1 class="flex items-cente space-x-2  font-light ">
              <span class="text-blue-500 text-3xl">•</span>
              <span className='xl:text-[1.9rem] lg:text-[1.4rem] leading-8 lg:leading-10'>Unlimited nationwide talk and text</span>
            </h1>
            <h1 class="flex items-cente space-x-2  font-light ">
              <span class="text-blue-500 text-3xl">•</span>
              <span className='xl:text-[1.9rem] lg:text-[1.4rem] leading-8 lg:leading-10'>No contracts,added texes or hidden fees</span>
            </h1>
            {/* contact number */}
          </div >
